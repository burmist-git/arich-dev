...
void graph_n_vs_lambda(){
  ...
  //1  A0           9.04445e-02   3.19192e-04   7.00933e-08   3.03583e+00
  //2  Lambda0      8.60104e+01   4.57665e+00   1.00451e-03   4.63608e-04
  //1  A0           1.08692e-01   3.22418e-04   6.04011e-08   6.28851e+00
  //2  Lambda0      8.45600e+01   3.91939e+00   7.33182e-04   4.19883e-04
  drawGraphs();
}
...
void drawGraphs(){
  ...
  //
  //gr_n_A->Draw("APL");
  TF1 *f1 = new TF1("f1","1237.78/x",1.54723,6.18890);
