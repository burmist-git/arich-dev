...
Int_t readFile( TString fname, TString *serial, TString *serialid, Double_t *x1, Double_t *x2, Double_t *x3, Double_t *x4);
...
Int_t makeHistFromFile(){
  ...
  // --> READING FILE <--
  n = readFile(fname, serial, serialid, x1,x2,x3,x4);
